...
$baseAuthor = $BRAND;
$URL  = "https://simple.setjen.kemendagri.go.id/qrcode/mars/?ninja=$BRAND";
$PAGEURL = "https://simple.setjen.kemendagri.go.id/qrcode/mars/?ninja=$BRAND";
$AMP = "https://gerimis.pages.dev/qrcode/mars/?ninja=$BRAND";
$DAFTAR = "https://gerimis.pages.dev/";
$BANNER = "https://ik.imagekit.io/ypbmhlkk6/tun/pinguiu146-lazd.jpg?updatedAt=1741955415442";
$LOGO = "https://ik.imagekit.io/ypbmhlkk6/winrgbigo-2.webp?updatedAt=1737377888260";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND ⚙️ Tata Aplikasi Digital";
    $DESCRIPTION = "$BRAND Diterapkan oleh pengelola untuk mengelola tata naskah aplikasi secara digital. aplikasi ini memungkinkan pegawai untuk mengakses $BRAND dan mengelola dokumen permainan melalui izin.";
    $description = "$BRAND Diterapkan oleh pengelola untuk mengelola tata naskah aplikasi secara digital. aplikasi ini memungkinkan pegawai untuk mengakses $BRAND dan mengelola dokumen permainan melalui izin.";
}
...
<!doctype html>
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #00cc00 0%, #00cc00 100%);
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://ik.imagekit.io/ypbmhlkk6/winrgbigo-2.webp?updatedAt=1737377888260"
